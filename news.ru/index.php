        ...
        <div class="container">
            <div class="row">
                <section class="content__left col-md-8">
                                ...
                                while ($art = mysqli_fetch_assoc($articles)) {
                                    ...
                                    <article class="article">
                                        ...
                                        <div class="article__info">
                                            ...
                                            <div class="article__info__preview"><?php echo mb_substr($art['text'], 0, 80, 'utf-8') . ' ...';?>
                                            </div>
                                        </div>
                                    </article>
                    ...
                    <div class="block">
                        <a href="/articles.php?categories=5">Все записи</a>
                        <h3>Безопасность [Новейшее]</h3>
                        <div class="block__content">
                            <div class="articles articles__horizontal">

                                <?php
                                $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id` = 5 ORDER BY `id` DESC LIMIT 10 ");
                                while ($art = mysqli_fetch_assoc($articles)) {
                                    ?>
                    ...
                    <div class="block">
                        <a href="/artciles.php?categories=2">Все записи</a>
                        <h3>Политика [Новейшее]</h3>
                        <div class="block__content">
                            <div class="articles articles__horizontal">
